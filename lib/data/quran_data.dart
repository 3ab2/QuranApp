final List<Map<String, dynamic>> surahs = [
  ...
  {"index": 47, "name": "محمد"},
  {"index": 48, "name": "الفتح"},
  {"index": 49, "name": "الحجرات"},
  {"index": 50, "name": "ق"},
  {"index": 51, "name": "الذاريات"},
  {"index": 52, "name": "الطور"},
  {"index": 53, "name": "النجم"},
  {"index": 54, "name": "القمر"},
  {"index": 55, "name": "الرحمن"},
  {"index": 56, "name": "الواقعة"},
  {"index": 57, "name": "الحديد"},
  {"index": 58, "name": "المجادلة"},
  {"index": 59, "name": "الحشر"},
  {"index": 60, "name": "الممتحنة"},
  {"index": 61, "name": "الصف"},
  {"index": 62, "name": "الجمعة"},
  ...
  {"index": 82, "name": "الانفطار"},
  {"index": 83, "name": "المطففين"},
  {"index": 84, "name": "الانشقاق"},
